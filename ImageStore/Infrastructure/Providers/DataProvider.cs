...
namespace ImageStore.Infrastructure.Providers
{
    public class DataProvider<T> : IDataProvider<T> where T : DomainObject
    {
        ...
        private static IDictionary IdentityMap => ImageStoreRegistry.Current.CommonInfrastructureProvider.IdentityMap;
        ...
        public T Find(Guid id)
        {
            ...
            if (subj == null)
            {
                ...
                ImageStoreRegistry.Current.CommonInfrastructureProvider.IdentityMap.Add(id.ToString(), subj);
            }
            return subj;
        }
