...
namespace YAShop.BusinessLogic.Bus.Commands
{
    ...
    public class CancelOldNotPaidOrdersCommandHandler : AbstractCommandHandler<CancelOldNotPaidOrdersCommand>
    {
        ...
        {
            var orders = await Registry.Current.Data.Orders.Select(" where State=0 and Date<@date",
                new {date = DateTime.Now.AddHours(-command.MaxDurationHours)});
            ...
            {
                await Status("No orders to cancel");
            }
